        ...
        <>
            <section className="grid gap-2 grid-cols-3">
                <div className="flex flex-col justify-center w-[350px] h-[170px] shadow border-gray rounded px-5">
                    ...
                    <p className="font-semibold text-[40px] text-orange">2</p>
                    <p className="font-medium text-[16px] text-gray">Nenhum pedido feito</p>
                </div>
                <div className="flex flex-col justify-center w-[350px] h-[170px] shadow border-gray rounded px-5">
                    <p className="font-semibold text-[16px]">Produtos em falta</p>
                    <p className="font-semibold text-[40px] text-red">4 <span className="text-[24px]">  &#x276f; 2</span></p>
                    <p className="font-medium text-[16px] text-gray"><span className="text-blue">4 </span>produtos com pedidos criados</p>
                </div>
